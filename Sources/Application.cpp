...
int main()
{
	...
	data = stbi_load("Resources/Textures/GDlogo.png", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		projection = glm::perspective(glm::radians(180.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
